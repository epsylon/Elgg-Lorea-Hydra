...
// Add decrypt option
if (strlen(strstr($post->description,"U2FsdGVkX1"))>0) {
        $post->description = '<div id="ID' . $post->guid . '" title="' . $post->description . '">' . $post->description . '<blockquote> <a href="javascript:decryptText(\'ID' . $post->guid . '\')">' . elgg_echo("elgg-crypt:decrypt") . '</a></blockquote></div>';
} else {
