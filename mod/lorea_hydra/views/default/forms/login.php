...
<div class="col-md-6">
    <div role="form">
        <div class="form-group">
            ...
            <input name='username' type="text" class="form-control" id="login_username" placeholder="<?php echo elgg_echo("loginusername"); ?>">
        </div>
        <div class="form-group">
            <label for="login_password"><?php echo elgg_echo("password"); ?></label>
            <input name='password' type="password" class="form-control" id="login_password" placeholder="<?php echo elgg_echo("password"); ?>">
        </div>
