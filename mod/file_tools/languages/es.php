...
return array(
	'file_tools' => "Herramientas de ficheros",
	...
	// group tool option
	'file_tools:group_tool_option:structure_management' => "Permitir la gestión de carpetas por las participantes",
	...
	'file_tools:forms:edit:change_files_access' => "Actualizar acceso en todos los ficheros en esta carpeta (y todas las subcarpetas si está seleccionado)",
	'file_tools:forms:browse' => 'Navegar..',
	'file_tools:forms:empty_queue' => 'Cola vacía',

	'file_tools:folder:delete:confirm_files' => "Quieres eliminar todos los ficheros de las (sub)carpetas eliminadas?",
	...
	'file_tools:action:edit:error:owner' => "No se pudo encontrar a la creadora de la carpeta",
	...
	//errors
	'file_tools:error:pageowner' => 'Error al obtener la creadora de la página.',
	...
	'widgets:file_tree:description' => "Muestra tu árbol de carpetas/ficheros",
	...
	'widget:file_tools:show_file' => 'Archivo destacado (modulo)',
	...
	// index_file
	'widgets:index_file:description' => "Mostrar los últimos archivos en la red",
