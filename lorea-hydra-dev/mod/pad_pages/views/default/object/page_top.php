<?php
/**
 * View for page object, overriden by Collaborative Pages plugin
 *
 * @package PadPages
 *
...
if ($full) {
	elgg_load_library('pad_pages');
	if($page->ispad){
		pad_pages_object_actions_menu(false, $page);
		$body = elgg_view('input/pad', array('padId' => 'test'));
		
	} else {
		pad_pages_object_actions_menu(true, $page);
