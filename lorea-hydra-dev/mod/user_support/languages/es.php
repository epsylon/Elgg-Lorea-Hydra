...
return array(
	...
	// annotations
	'river:comment:object:support_ticket' => "%s ha escrito un comentario en el ticket %s",
	'river:create:object:support_ticket' => "%s ha escrito un comentario en el ticket %s",
...
%s",
	...
	'user_support:menu:support_tickets:mine' => "Contribuciones",
