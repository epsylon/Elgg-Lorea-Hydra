...
return array(
	...
	'gnusocial_api:settings:instructions' => 'Debes obtener una clave p&uacute;blica y privada en <a href="https://dev.gnusocial.com/apps/new" target="_blank">GNUSocial</a>. Llena el formulario para la nueva aplicaci&oacute;n. Selecciona "Browser" como el nuevo tipo de aplicaci&oacute;n y "Read & Write" para el tipo de acceso. La URL de callback es is %sgnusocial_api/authorize',

	'gnusocial_api:usersettings:description' => "Enlaza tu cuenta %s con GNUSocial.",
	'gnusocial_api:usersettings:request' => "Primero debes <a href=\"%s\">autorizar</a> %s para acceder a tu cuenta de GNUSocial.",
	'gnusocial_api:usersettings:cannot_revoke' => "No pueds desenlazar tu cuent6a con GNUSocial debido a que no has provisto una direcci&oacute;n de email y contrase&ntilde;a. <a href=\"%s\">Proveer una ahora</a>.",
	...
	'gnusocial_api:revoke:success' => 'El acceso a GNUSocial ha sido rebocado.',
