    <div class="container">
        ...
        <div class="pane" id="pane_1" style="display: none">
            <input type="text" placeholder="Nombre de la sala" id="room_field" class="form-control"><br>
            <input type="button" value="Crear/Participar en conferencia" id="join" class="btn btn-info btn-default btn-block">
        </div>

        <div class="pane" id="pane_2" style="display: none">
            <div id="video_container"></div>
            <input type="button" value="Salir de conferencia" id="quit" class="btn btn-danger btn-default btn-block">
        </div>
    </div>
...
function joinConference(){
    ...
    if( roomToJoin ){
        ...
        alert( "Tienes que poner un nombre a la sala !" )
    }
}
